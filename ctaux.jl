...
=#
    ...
    function calc_insert_det(vertex,rspin) #for debug. slow update
        ...
        mat_D = calc_det_D(rspin,currentk+1)
    ...
    function calc_remove_det(vertex,rspin) #for debug. slow update
        global τcon,spincon,indexcon,currentk,β
